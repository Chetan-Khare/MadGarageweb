...
import {
  Search, ChevronRight, Zap, Target, ShieldCheck,
      ...
      <section className="relative min-h-[750px] bg-app-bg-dark overflow-hidden flex items-center justify-center pt-20 pb-10">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <div className="max-w-6xl mx-auto space-y-4">
            ...
            {showVehicleFilters && (
              <div className="bg-white p-8 md:p-12 rounded-[2.8rem] border border-gray-100 shadow-2xl">
                ...
                <div className="mt-10 flex flex-col md:flex-row items-center justify-between gap-6 pt-10 border-t border-gray-50">
                  ...
                  >
                    <Zap size={14} /> Reset Vehicle Profile
                  </button>
                  <button
      ...
      <section id="marketplace-section" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-12 flex flex-col md:flex-row items-center justify-between gap-8 py-6 border-b border-gray-100 sticky top-16 z-30 bg-white/95 backdrop-blur-md">
            <div className={`flex flex-col lg:flex-row items-center gap-6 w-full justify-end`}>
                  ...
                  <div className="aspect-square bg-gray-50 flex items-center justify-center p-8 relative overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                      <button
                        ...
                        className={`h-11 w-11 rounded-full flex items-center justify-center shadow-lg backdrop-blur-md transition-all ${isInWishlist(product.id) ? 'bg-primary text-white' : 'bg-white/90 text-app-bg-dark hover:bg-primary hover:text-white'}`}
                      >
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    ...
                    <div className="mt-auto pt-6 border-t border-gray-50 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-black italic text-app-bg-dark tracking-tighter">Rs.{(product.garagePrice || product.price || 0).toLocaleString()}</p>
                      </div>
                      <div
                        className="h-12 w-12 bg-app-bg-dark text-white rounded-2xl flex items-center justify-center group-hover:bg-primary transition-all shadow-lg"
